       ...
       public string GetGroupId()
        {
            ...
            // CORREÇÃO CRÍTICA (AOT Safe): Busca os elementos ignorando completamente os namespaces
            // Compara apenas o nome puro da tag XML ("groupId" ou "parent")
            var groupId = doc.Root.Elements()
                .FirstOrDefault(e => e.Name.LocalName.Equals("groupId", StringComparison.OrdinalIgnoreCase))?.Value;

            // Se não achar o groupId na raiz, busca dentro da tag <parent> de forma segura
        ...
        public string GetArtifactId()
        {
            ...
            // O Maven usa o namespace padrão "http://maven.apache.org/POM/4.0.0"
